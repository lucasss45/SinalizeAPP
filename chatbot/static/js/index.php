...
<body>
    <header class="cabecalho container">
        <img src="static/img/logo-chatbot.svg" alt="Logo Chatbot">
    ...
    <main class="main">
        ...
        <section class="entrada container">
            <div class="entrada__container">
                ...
                <button aria-label="Botão de enviar" id="botao-enviar"><img src="static/img/enviar.png" alt="" style="height: 28px;"></button>
            </div>
        </section>
    </main>
